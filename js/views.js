...
export function renderGuide() {
  ...
  fill(body,
    ...
    section('Encounter Mode \u2014 catching things',
      ...
      defs([
        ['Shiny', `Every creature rolled has a ${(SHINY_ODDS * 100).toFixed(0)}% chance of being shiny, a gate boss twice that, and everything doubles again once your score passes ${fmtScore(SHINY_DOUBLE_AT)}. You will not miss one: a rainbow ring cycles around it on the table, a SHINY badge sits above it, it is announced when it appears, the mode banner turns gold, and it scores a large bonus. Shinies are tracked separately in your Collection.`],
        ['NEW', 'A green NEW badge above a creature means it is not in your Collection yet \u2014 so it is worth more than points, and worth spending the ball on. During an evolution the badge is about the form it will become, since that is what gets registered.'],
